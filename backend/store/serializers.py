...
class ProductDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'product_name', 'slug', 'description', 'category',
                  ...
                  'variant_label', 'has_color',
                  'product_colors', 'reviews', 'review_summary',
                  'attributes', 'created_at']

    def get_variant_label(self, obj):
        """What to call the size/storage selector: 'Size' or 'Storage'."""
        from store.variant_config import get_category_variants
        return get_category_variants(obj.category)['label']

    def get_has_color(self, obj):
        """Whether this product renders a color selector."""
        from store.variant_config import get_category_variants
        return get_category_variants(obj.category)['has_color']
